const Projects = () => {
  return (
    <div className="w-10/12 mx-auto mt-6 fade-up-delay-700 mb-12 grid grid-cols-6 lg:gap-1 rounded-md">
      <p className="p-4 roboto-flex-400 col-span-6 lg:col-span-3 border border-neutral-400 lg:rounded-lg bg-white shadow-md shadow-zinc-500">
        ...
        respuestas a consultas frecuentes, programar citas y sincronizar datos
        con el CRM, mejorando la eficiencia operativa y la experiencia del
        usuario. Gracias a esta solución,
      </p>

      <img
        alt="crm-wa"
        src="/crm-wa.png"
        className="w-full h-full col-span-6 lg:col-span-3 lg:rounded-md shadow-md shadow-zinc-500"
      />
    </div>
  );
};
